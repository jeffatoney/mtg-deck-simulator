...
RULES_BY_NAME: dict[str, tuple[dict[str, Any], ...]] = {
    ...
    "Arcane Signet": (
        activated("arcane-signet:mana", "ADD_COMMANDER_COLOR", tap=True, mana_ability=True),
    ),
    "Ash Barrens": (
    ...
    "Breeches, Brazen Plunderer": (
        triggered(
            "breeches:pirate-damage", "PIRATE_DAMAGE_TO_OPPONENTS", "RECORD_UNKNOWN_BREECHES_EXILES"
        ),
    ),
    "Brotherhood's End": (
    ...
    "By Force": (
        spell(
            "DESTROY_TARGETS", targets="ARTIFACT", minimum=0, maximum=None, target_count_from_x=True
        ),
    ),
    "Cascade Bluffs": (
    ...
    "Command Tower": (
        activated("command-tower:mana", "ADD_COMMANDER_COLOR", tap=True, mana_ability=True),
    ),
    "Commit // Memory": (
    ...
    "Crab Umbra": (
        ...
        {
            "ability_id": "crab-umbra:umbra-armor",
            "kind": "REPLACEMENT",
            "event": "ENCHANTED_CREATURE_DESTROY",
            "effect": {"kind": "UMBRA_ARMOR"},
        },
    ),
    "Curiosity": (
        spell("ATTACH_AURA", targets="CREATURE", minimum=1, maximum=1),
    ...
    "Demolition Field": (
        ...
        activated(
            ...
            tap=True,
            sacrifice=True,
            targets="OPPONENT_NONBASIC_LAND",
            minimum=1,
            maximum=1,
        ),
    ),
    ...
    "Dualcaster Mage": (
        triggered(
            ...
            "ETB",
            "CREATE_SPELL_COPY",
            targets="INSTANT_OR_SORCERY_SPELL",
            minimum=1,
            maximum=1,
    ...
    "Electroduplicate": (
        ...
        {
            "ability_id": "electroduplicate:flashback",
            "kind": "CAST_PERMISSION",
            "permission": "FLASHBACK",
            "cost": "{2}{R}{R}",
        },
    ),
    "Evolving Wilds": (
        activated(
            "evolving-wilds:fetch", "FETCH_BASIC", tap=True, sacrifice=True, enters_tapped=True
        ),
    ),
    "Exotic Orchard": (
        activated("exotic-orchard:mana", "ADD_OPPONENT_PROFILE_COLOR", tap=True, mana_ability=True),
    ),
    "Expedite": (
        spell(
            "SEQUENCE",
            ...
            maximum=1,
            effects=(
                {"kind": "GRANT_HASTE", "duration": "END_OF_TURN"},
                {"kind": "DRAW", "count": 1},
            ),
        ),
    ),
    ...
    "Faithless Looting": (
        ...
        {
            "ability_id": "faithless-looting:flashback",
            "kind": "CAST_PERMISSION",
            "permission": "FLASHBACK",
            "cost": "{2}{R}",
        },
    ...
    "Fellwar Stone": (
        activated("fellwar-stone:mana", "ADD_OPPONENT_PROFILE_COLOR", tap=True, mana_ability=True),
    ),
    ...
    "Introduction to Annihilation": (
        spell("EXILE_THEN_CONTROLLER_DRAWS", targets="NONLAND_PERMANENT", minimum=1, maximum=1),
    ),
    "Invert // Invent": (
        spell(
    ...
    "Opt": (
        spell("SEQUENCE", effects=({"kind": "SCRY", "count": 1}, {"kind": "DRAW", "count": 1})),
    ),
    "Path of Ancestry": (
        {
            "ability_id": "path:enters",
            "kind": "REPLACEMENT",
            "event": "ENTERS_BATTLEFIELD",
            "effect": {"kind": "ENTER_TAPPED"},
        },
    ...
    "Reality Ripple": (
        spell("PHASE_OUT", targets="ARTIFACT_CREATURE_OR_LAND", minimum=1, maximum=1),
    ),
    ...
    "Soul-Guide Lantern": (
        triggered(
            "lantern:etb", "ETB", "EXILE_TARGET", targets="GRAVEYARD_CARD", minimum=1, maximum=1
        ),
        activated("lantern:opponent-graves", "EXILE_OPPONENT_GRAVEYARDS", tap=True, sacrifice=True),
    ...
    "Syncopate": (
        spell(
            "COUNTER_UNLESS_PAY_EXILE", targets="SPELL", minimum=1, maximum=1, amount_from_x=True
        ),
    ),
    "Temple of Epiphany": (
        {
            "ability_id": "temple:enters",
            "kind": "REPLACEMENT",
            "event": "ENTERS_BATTLEFIELD",
            "effect": {"kind": "ENTER_TAPPED"},
        },
        ...
        activated(
            "temple:mana", "ADD_CHOSEN_MANA", tap=True, mana_ability=True, choices=("U", "R")
        ),
    ),
    "Terramorphic Expanse": (
        activated(
            "terramorphic:fetch", "FETCH_BASIC", tap=True, sacrifice=True, enters_tapped=True
        ),
    ),
    "Thriving Isle": (
        {
            "ability_id": "thriving:as-enters",
            "kind": "REPLACEMENT",
            "event": "ENTERS_BATTLEFIELD",
...
RULES_BY_NAME["Storm Fleet Sprinter"] = (
    {
        "ability_id": "sprinter:haste",
        "kind": "STATIC",
        "effect": {"kind": "KEYWORD", "name": "Haste"},
    },
...
RULES_BY_NAME["Faithless Looting"] = (
    ...
    spell(
        "DRAW_DISCARD", mode="flashback", draw=2, discard=2, permission="FLASHBACK", cost="{2}{R}"
    ),
)
