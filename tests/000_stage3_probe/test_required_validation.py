...
COMMANDS = (
    ...
    (
        "continuous_combo_access",
        ["uv", "run", "pytest", "-q", "tests/phase_b/test_continuous_combo_access.py", "-vv"],
        0,
    ),
    ("measurements", ["uv", "run", "pytest", "-q", "tests/phase_b/test_measurements.py", "-vv"], 0),
    (
        "glint_action_surface",
    ...
    (
        ...
        [
            ...
            "pytest",
            "-q",
            "tests/phase_c/test_malcolm_glint_horn_witness_contract.py",
            "-vv",
        ],
        0,
    ),
    (
        "terminal_cleanup",
        ["uv", "run", "pytest", "-q", "tests/phase_c/test_phase_c_terminal_cleanup.py", "-vv"],
        1,
    ),
    (
        "phase_c_700_regressions",
        ["uv", "run", "pytest", "-q", "tests/phase_c/test_phase_c_700_regressions.py", "-vv"],
        0,
    ),
    (
        "phase_c_timing",
        ["uv", "run", "pytest", "-q", "tests/phase_c/test_phase_c_timing.py", "-vv"],
        0,
    ),
