...
FROZEN = (
    ...
    "tests/phase_a_acceptance/test_reference_contract.py",
    "tests/phase_a_acceptance/test_forced_scenarios.py",
    "tests/phase_a_acceptance/test_trace_invariants.py",
    "tests/phase_a_acceptance/test_replay_contract.py",
    "tests/phase_a_acceptance/test_analytics_contract.py",
    "tests/phase_a_acceptance/reference_adapter.py",
